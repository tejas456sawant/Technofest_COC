...
<div class="row">
<div class="col-lg-6">
<span class="logo">CLASH OF CODES - MIX Edition</span></div>
...
if (!(isset($_SESSION['username']))) {
    ...
    include_once 'dbConnection.php';
    echo '<span style="margin-top:3.8%;margin-left:-20%;"class="pull-right top title1" ><span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <span class="log log1" style="color:lightyellow">' . $username . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
?>
</div>
</div></div>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($rowcount == 0) {      
            ...
            <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&cnt=111&t=' . $total . '&start=start&ques_arr='. implode(',',$ques_no_arr) .'" class="btn" style="color:#FFFFFF;background:darkgreen;font-size:12px;padding:7px;padding-left:10px;padding-right:10px"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span><b>Start</b></span></a></b></td></tr>';
        } else {
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&cnt='. @$_GET['cnt'] .'&t=' . $total . '&start=start&ques_arr='. implode(',',$ques_no_arr) .'" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Continue</b></span></a></b></td></tr>';
            } else {
                echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">+' . $correct . '</td><td style="vertical-align:middle">-' . $wrong . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['6e447159425d2d']) && $_SESSION['6e447159425d2d'] == "6e447159425d2d" && @$_GET['endquiz'] == 'end') {
    ...
    $q_quiz_name = mysqli_query($con, "SELECT * FROM quiz WHERE eid='$_GET[eid]' ") or die('Error:quiz_name-197');
    while ($row_qname = mysqli_fetch_array($q_quiz_name)) {
        $quizname = $row_qname['title'];
    }
    $q_end_time=mysqli_query($con, "INSERT INTO user_end_time VALUES(NULL,'$username','$quizname',NOW())") or die('Error_Time-137');    
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_GET['start']) && $_GET['start'] == "start" && (!isset($_SESSION['6e447159425d2d']))) {
    ...
    if (mysqli_num_rows($q) > 0) {
        ...
        if ($status == "ongoing" && $remaining > 0 && $qstatus == "enabled") {
            ...
            header('location:account.php?q=quiz&step=2&eid=' . $_GET[eid] . '&n=' . $_GET[n] . '&t=' . $_GET[t] .'&cnt='. @$_GET['cnt'] .'&ques_arr='.@$_GET['ques_arr']);
        ...
        $q_time=mysqli_query($con, "INSERT INTO user_start_time VALUES(NULL,'$username','$quizname',NOW())") or die('Error_Time-137');    
...
function end(){
  data = prompt("Are you sure to end this Quiz? Remember, once finished, you wont be able to continue anymore. If you want to finish quiz then enter \\"yes\\" in the textbox below and click \\"OK\\"");
  if(data=="yes"){
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
            ...
            echo '<font size="3" style="margin-left:100px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Time Left : </font><span class="timer btn btn-default" style="margin-left:20px;"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue" id="countdown"></font></span><span class="timer btn btn-primary" style="margin-left:50px;margin-top:-0.6%;" onclick="end()"><span class=" glyphicon glyphicon-off" ></span>&nbsp;&nbsp;<font style="font-size:12px;font-weight:bold"><br>Finish Quiz</font></span>';
            $eid   = @$_GET['eid'];
            $sn    = @$_GET['n'];
            $total = @$_GET['t'];

            //print_r(@$_GET['cnt']);
            $q_arr=preg_split ("/\,/", @$_GET['ques_arr']); 
            //print_r($q_arr);
            $q_no=$q_arr[$sn-1];

            $cnt=0;
            $q     = mysqli_query($con, "SELECT * FROM questions WHERE eid='$eid' AND sn='$q_no' ");
            echo '<div class="panel" style="margin-right:5%;margin-left:5%;margin-top:10px;border-radius:10px">';
            while ($row = mysqli_fetch_array($q)) {
                $qns = stripslashes($row['qns']);
                $qid = $row['qid'];
                echo '<b><pre style="background-color:white"><div style="font-size:18px;font-weight:bold;font-family:calibri;margin:10px">' . $sn . ' : ' . $qns . '</div></pre></b>';
            }
            
            echo '<form id="qform" action="update.php?q=quiz&step=2&eid=' . $eid . '&n=' . $sn . '&t=' . $total . '&qid=' . $qid . '&ques_arr='.@$_GET['ques_arr'].'" method="POST"  class="form-horizontal">
<br />';
            ...
            if (strlen($ans) > 0) {
                $str=@$_GET['ques_arr'];
                echo "<div style=\"margin-left:1%;margin-top:-0.7%;\"><font style=\"color:green;font-size:12px;font-weight:bold\">Selected Answer : </font><font style=\"color:#565252;font-size:12px;\">" . $ans . "</font>&nbsp;&nbsp;<br /><font style=\"color:green;font-size:12px;font-weight:bold\">If you want to change answer click on : </font><a href=update.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total&ques_arr=$str&qid=$qid&delanswer=delanswer><span class=\"glyphicon glyphicon-remove\" style=\"font-size:12px;color:darkred\"></span></a></div><br />";
            }
            else
            {
                echo "<div style=\"margin-left:1%;margin-top:-0.7%;margin-bottom:1.5%;\"><font style=\"color:green;font-size:12px;font-weight:bold\">Selected Answer : </font><font style=\"color:#565252;font-size:12px;\"> NONE </font>&nbsp;&nbsp;<br /></div><br />";
            }
            echo '<div class="funkyradio" style="margin-left:1%;width:195%;">';
            $q = mysqli_query($con, "SELECT * FROM options WHERE qid='$qid' ");
            while ($row = mysqli_fetch_array($q)) {
                $option   = stripslashes($row['option']);
                $optionid = $row['optionid'];
                echo '<div class="funkyradio-success"><input type="radio" id="' . $optionid . '" name="ans" value="' . $optionid . '" onclick="enable()"> <label for="' . $optionid . '" style="width:50%"><div style="color:black;font-size:12px;"></div><div style=";margin-left:6%;">' . $option . '</div></label></div>';
            }
            echo '</div>';
            
            if (@$_GET[t] > @$_GET[n] && @$_GET[n] != 1) {
                echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '&cnt='.@$_GET['cnt'].'&ques_arr='.@$_GET['ques_arr'].'" class="btn btn-primary" style="height:30px;margin-left:1%;"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Lock</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '&cnt='.@$_GET['cnt'].'&ques_arr='.@$_GET['ques_arr'].'" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
                ...
                echo '<br />&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px;margin-left:1%;"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Lock<font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '&cnt='.@$_GET['cnt'].'&ques_arr='.@$_GET['ques_arr'].'" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
                // <button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;
            } else {
            }

            echo '</div>';
            echo '<div class="panel" style="text-align:center;"><br>';
            ...
            for ($i = 1; $i <= $total; $i++) {
                if ($i==28)
                    echo '<br><br>';
                echo '<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . $i . '&t=' . $total . '&cnt='.@$_GET['cnt'] .'&ques_arr='.@$_GET['ques_arr'].'"  style="margin:5px;padding:5px;background-color:';
                if ($quesans[$q_arr[$i-1]]) {
                    echo "darkgreen";
                } else  {
                    echo "#f1f1f1";
                }
                echo ';color:darkturquoise;font-size:16px;font-family:calibri;border-radius:4px">&nbsp;' . $i . '&nbsp;</a>';
            }
        } else {
            unset($_SESSION['6e447159425d2d']);
            $q = mysqli_query($con, "UPDATE history SET status='finished' WHERE username='$_SESSION[username]' AND eid='$_GET[eid]' ") or die('Error197');
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
    ...
    <tr style="color:darkblue"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        ...
        // Display Answers of questions in result page
        /*
        echo '<div class="panel"><br /><h3 align="center" style="font-family:calibri">:: Detailed Analysis ::</h3><br /><ol style="font-size:20px;font-weight:bold;font-family:calibri;margin-top:20px">';
...
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel title">
    <center><h3>Top-10 Teams</h3></center><br>
    <table class="table table-striped title1" >
    <tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Team Name</b></td><td style="vertical-align:middle;"><b>Score</b></td></tr>';
        $c = $showfrom-1;
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            $e = $row['username'];
            $s = $row['score'];
            $q12 = mysqli_query($con, "SELECT * FROM user WHERE Team_name='$e' ") or die('Error231');
            while ($row = mysqli_fetch_array($q12)) {
                $name_new     = $row['Team_Name'];
            }
            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td style="vertical-align:middle">' . $name_new . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle">';
        }
    }
    else{
    }
...
<div class="row footer" style="margin-top:12.2%;">

<div class="col-md-6 box" style="width:100%;">
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')" target="new">About TECHNOFEST2k20</a></div>
-->
</div>
</body>
</html>
