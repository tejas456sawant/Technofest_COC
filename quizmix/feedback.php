...
<body style="background-image:url(image/download1.png);background-size:cover;">
<div class="row header" style="background:rgba(0,0,0,0.6);">
<div class="col-lg-6" style="margin-top:0.1%;">
...
if ((!isset($_SESSION['username']))) {
    echo '<a href="#" class="pull-right logb btn btn-primary" data-toggle="modal" data-target="#myModal" style="color:white;margin-top:1.9%;"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Login</font></a>&nbsp;';
} else {
...
<a href="index.php" class="pull-right btn logb btn-primary" style="color:white;margin-top:1.9%;"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Home</font></a>&nbsp;
</div></div>
...
<div class="bg1" style="background-image:none;background-color:transparent;min-height:430px;">
<div class="row" style="min-height:658px;">
<div class="col-md-3" ></div>
<div class="col-md-6 panel" style="background:#ffffff;border-radius:10px;margin-top:7%;">
<h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK</h2>
<div style="font-size:14px;margin-top:20px"><br /><br />
<?php
if (@$_GET['q'])
...
<font style="font-size:12px;font-weight:bold"><br /><input type="submit" name="submit" value="Send My Feedback" class="btn btn-primary" /></font>
</div>
</form>';
}
?>
...
<div class="col-md-2 box" style="width:30%;margin-left:20%;margin-top:0.6%;">
<a href="about.php" style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">About TECHNOFEST2k20</a></div>
</div>
</body>
</html>
