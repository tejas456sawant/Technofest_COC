...
<div class="header">
<div class="row">
<div class="col-lg-6" style="margin-top:0.2%;">
...
if (!(isset($_SESSION['username']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
    ...
    include_once 'dbConnection.php';
    echo '<span style="margin-top:1%;" class="pull-right top title1" ><span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <span class="log log1" style="color:lightyellow">' . $name . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
?>
...
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">Users Not Attempting Exam</a></li>
    <li <?php
if (@$_GET['q'] == 2)
    echo 'class="active"';
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Team Name</b></td><td style="vertical-align:middle"><b>Mob.No</b></td><td style="vertical-align:middle"><b>E-mail</b></td>
<td style="vertical-align:middle"><b>Start Time</b></td><td style="vertical-align:middle"><b>End Time</b></td><td style="vertical-align:middle"><b>Score</b></td>';
    $c = $showfrom-1;
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            while ($row1 = mysqli_fetch_array($q12)) {
                $tname      = $row1['Team_Name'];
                $phno       = $row1['mob_no'];
                $email      = $row1['Email'];
                $pwd        = $row1['password'];
            }
            
            $q_start = mysqli_query($con, "SELECT * FROM user_start_time WHERE username='$e' ") or die('Error-start_time231');
            while ($row2 = mysqli_fetch_array($q_start)) {
                $start_time=$row2['start_time'];
            }

            $q_end = mysqli_query($con, "SELECT * FROM user_end_time WHERE username='$e' ") or die('Error-end_time231');
            while ($row3 = mysqli_fetch_array($q_end)) {
                $end_time=$row3['end_time'];
            }

            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td style="vertical-align:middle">' . $tname . '</td><td style="vertical-align:middle">' . $phno . '</td><td style="vertical-align:middle">' . $email . '</td>
            <td style="vertical-align:middle">' . $start_time . '</td><td style="vertical-align:middle">' . $end_time . '</td><td style="vertical-align:middle">' . $s . '</td>';
        }
    }
    else{
    }
...
if (@$_GET['q'] == 1) {
    ...
    $result = mysqli_query($con, "SELECT * FROM user ORDER BY Team_Name") or die('Error');
    echo '<div class="panel"><table class="table table-striped title1">
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Team Name</b></td><td style="vertical-align:middle"><b>Applicant-1</b></td><td style="vertical-align:middle"><b>Applicant-2</b></td><td style="vertical-align:middle"><b>Mob.No</b></td><td style="vertical-align:middle"><b>E-mail</b></td><td style="vertical-align:middle"><b>Password</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $tname      = $row['Team_Name'];
        $app1       = $row['Applicant1'];
        ...
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $tname . '</td><td style="vertical-align:middle">' . $app1 . '</td><td style="vertical-align:middle">' . $app2 . '</td><td style="vertical-align:middle">' . $phno . '</td><td style="vertical-align:middle">' . $email . '</td><td style="vertical-align:middle">' . $pwd . '</td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
if (@$_GET['q'] == 6) {
    ...
    $result1 = mysqli_query($con, "SELECT * FROM user ORDER BY Team_Name") or die('Error');
    echo '<div class="panel"><table class="table table-striped title1">
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Team Name</b></td><td style="vertical-align:middle"><b>Applicant-1</b></td><td style="vertical-align:middle"><b>Applicant-2</b></td><td style="vertical-align:middle"><b>Mob.No</b></td><td style="vertical-align:middle"><b>E-mail</b></td><td style="vertical-align:middle"><b>Password</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result1)) {
        ...
        $result_rank_new = mysqli_query($con, "SELECT * FROM rank where username='$tname'") or die('Error');
        $rowcount = mysqli_num_rows($result_rank_new);
        if ($rowcount==0)
        {   echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $tname . '</td><td style="vertical-align:middle">' . $app1 . '</td><td style="vertical-align:middle">' . $app2 . '</td><td style="vertical-align:middle">' . $phno . '</td><td style="vertical-align:middle">' . $email . '</td><td style="vertical-align:middle">' . $pwd . '</td></tr>';
        }
    }
